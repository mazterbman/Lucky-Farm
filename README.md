...
[![Gameplay Preview](https://img.youtube.com/vi/ВАШ_YOUTUBE_ID/maxresdefault.jpg)](https://www.youtube.com/watch?v=ВАШ_YOUTUBE_ID)
...
Assets/
├── Scripts/
│   ├── Core/           # DI-биндинги, точки входа
│   ├── Farm/           # Логика фермы (посадка, сбор, рост)
│   ├── Inventory/      # Система инвентаря
│   ├── Loading/        # Addressables-загрузчики
│   └── Services/       # Сервисы: экономика, сохранение и т.д.
├── Scenes/
│   └── Game.unity
└── Prefabs/            # Адресуемые префабы
```
